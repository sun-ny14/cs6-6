// js/point-guide.js
// 포인트 도감 / 인벤토리 / 승인 / 환불 / 포인트 연대기 / 일괄 지급
...
window.initPointsTabListeners = function() {
    if (window.isPointsListenerAttached) {
        return;
    }
    ...
    db.ref("orders").on("value", snap => {
            ...
            if (
                ...
                uHtml += `
                    ...
                    ">
                        ...
                        <button
                            onclick="requestUseItem(
                                '${key}',
                                '${String(o.item || "").replace(/'/g, "\\'")}'
                            )"
                            style="
                                background:#3498db;
                                color:white;
        ...
        const uEl =
            document.getElementById("inv-unused");
        ...
        const wEl =
            document.getElementById("inv-waiting");
    ...
    function(
        ...
        document.getElementById(
            ...
            ">
                ...
                <button
                    onclick="savePointGuideModal('${String(key).replace(/'/g, "\\'")}')"
                    style="
                        background:#3498db;
                        color:white;
                        border:none;
            ...
            bodyHtml += `
                ...
                ">
                    ...
                    <input
                        ...
                        value="${u.key}"
                        data-name="${String(u.name).replace(/"/g, "&quot;")}"
                        style="
                            position:absolute;
                            top:8px;
                            left:8px;
